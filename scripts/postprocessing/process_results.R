...
write.csv(sim.dat, paste0(results_dir, "/summarized_results/simulation_derived_dnds.csv", sep=""), row.names=FALSE, quote=FALSE)
...
#         }
#         write.csv(sim.selcoeffs, paste0(results_dir, "summarized_results/",  full_dataset, "_selection_coefficients.csv", sep=""), row.names=FALSE, quote=FALSE)
#     }
# }
# 
# 

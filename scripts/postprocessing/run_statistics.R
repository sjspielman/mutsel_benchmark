...
##### K-S Tests between strong, weak. All P>=0.15 ######
...
for (d in datasets){
    print(d)
    strong.sc <- read_csv(paste0(result_directory, d, "_delstrong_selection_coefficients.csv"))
    true      <- read_csv(paste0(true_directory, d, "_delstrong_true_selcoeffs.csv"))
...
for (d in datasets){
    print(d)
    weak.sc <- read_csv(paste0(result_directory, d, "_delweak_selection_coefficients.csv"))
    true      <- read_csv(paste0(true_directory, d, "_delweak_true_selcoeffs.csv"))

...
emp.datasets <- c("PF01336", "PF01926", "PF02518", "PF04055", "PF07715")
...
write.csv(results.dnds, paste0(datadir_parent, "NEWdnds_results.csv", sep=""), row.names=FALSE, quote=FALSE)

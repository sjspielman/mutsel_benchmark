/* SJS 2/15/15. Script to automate FEL analyses. Uses the MG94xHKY85 model with dN and dS as separate parameters.*/
...
inputRedirect["08"]="Two rate FEL";     // 1-rate FEL (dS constant across sites)
inputRedirect["09"]="0.01";             // FPR for LRT
inputRedirect["10"]="All";             // run whole tree
inputRedirect["11"]=WDIR+outfile;       // output file


ExecuteAFile (HYPHYDIR + "QuickSelectionDetection.bf", inputRedirect);

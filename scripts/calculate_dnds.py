...
emp_datasets = ["PF01336", "PF01926", "PF02518", "PF04055", "PF07715"] #"pb2", "PF00126", "PF00593", "PF01266", 
...
#inftypes = {"empirical": ["nopenal", "phylobayes"], "simulation": ["phylobayes", "mvn10", "mvn100", "mvn1000", "d1.0", "d0.1", "d0.01", "nopenal"]}
...
for datatype in datasets:
    ...
    for data in datasets[datatype]:        
        for method in methods: #inftypes[datatype]:
